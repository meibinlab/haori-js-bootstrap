...
<script src="https://cdn.jsdelivr.net/npm/haori-bootstrap@0.5.21/dist/haori-bootstrap.iife.js"></script>
```
...
Example next patch release after `0.5.21`:

```bash
# version becomes 0.5.22
npm version patch
git push origin main --follow-tags
```

Create and publish the GitHub Release for the pushed tag such as `0.5.22`.
