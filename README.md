...
/>
<script src="https://cdn.jsdelivr.net/npm/haori@0.32.0/dist/haori.iife.js"></script>
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.8/dist/js/bootstrap.bundle.min.js"></script>
<script src="https://cdn.jsdelivr.net/npm/haori-bootstrap@0.5.14/dist/haori-bootstrap.iife.js"></script>
```
...
Example next patch release after `0.5.14`:

```bash
# version becomes 0.5.15
npm version patch
git push origin main --follow-tags
```

Create and publish the GitHub Release for the pushed tag such as `0.5.15`.
