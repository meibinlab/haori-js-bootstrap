...
<script src="https://cdn.jsdelivr.net/npm/haori-bootstrap@0.5.42/dist/haori-bootstrap.iife.js"></script>
```
...
Example next patch release after `0.5.42`:

```bash
# version becomes 0.5.43
npm version patch
git push origin main --follow-tags
```

Create and publish the GitHub Release for the pushed tag such as `0.5.43`.
